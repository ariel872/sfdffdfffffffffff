...
module.exports = {
   ...
   if(!message.member.roles.cache.find(r => r.id === "829397786046758952")) return message.channel.send('You are not allowed to start giveaways');
        ...
        client.giveawaysManager.start(channel, {
            ...
            messages: {
                ...
                giveawayEned: (client.config.everyoneMention ? "" : "") + "GIVEAWAY ENDED",
